  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <div className="container mx-auto px-6 md:px-12 py-12 md:py-20">
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-xs tracking-[0.15em] uppercase text-muted-foreground hover:text-foreground transition-colors duration-500 mb-10"
